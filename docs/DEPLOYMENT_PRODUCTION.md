...
**Imagen actual:** `sicedia/spiderhub:0.1.0-rc.17`  
...
docker save sicedia/spiderhub:0.1.0-rc.17 | gzip > spiderhub-0.1.0-rc.17.tar.gz
```
...
scp spiderhub-0.1.0-rc.17.tar.gz cedia@ubuntu24:~/spiderhub/
```
...
# 2. Cargar la imagen
docker load < spiderhub-0.1.0-rc.17.tar.gz

# 3. Actualizar docker-compose.yml
# Editar y cambiar la versión de la imagen a: sicedia/spiderhub:0.1.0-rc.17
...
# 2. Push la imagen
docker push sicedia/spiderhub:0.1.0-rc.17
...
# image: sicedia/spiderhub:0.1.0-rc.17
...
web:
  ...
  image: sicedia/spiderhub:0.1.0-rc.17  # <-- Versión actualizada
  tmpfs:
